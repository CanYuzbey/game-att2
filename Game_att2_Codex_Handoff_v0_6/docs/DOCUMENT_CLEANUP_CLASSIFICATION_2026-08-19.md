...
- Director working context in document 38, Brain authority in document 39, and the
  cross-system reconciliation in document 40.
...
## 2026-08-21 integration disposition

The later Brain approval collided with the director cleanup only in document numbering
and deck-layer ownership. The Director's Choice working record keeps number 38, the
Brain Module becomes document 39, and document 40 records the complete comparison.
The approved baseline uses body construction plus Brain configuration rather than a
second conventional active-deck system.

Documents 29 and 34 remain active historical bridges because their non-superseded
staged-turn, physical-compatibility, inventory-ownership, timing, and evidence
contracts remain unique. Their obsolete slot guarantees/readiness are labelled and
cannot be used as current acceptance criteria.

No additional tracked file was empty, an exact duplicate, generated, unrelated, or
free of decision/evidence value. Further deletion was therefore rejected. This is an
intentional preservation decision, not incomplete cleanup.
