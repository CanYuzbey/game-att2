...
> **SUPERSEDED RULE VERSION.** Preserved for traceability. Combat Rules v0.5 is
> the active simulator rule authority.

Historical status: approved for simulator testing, not final balance.
